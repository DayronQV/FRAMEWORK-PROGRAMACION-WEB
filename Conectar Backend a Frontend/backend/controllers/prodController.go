...
func GetProductos(c *fiber.Ctx) error {
	...
	productos := []models.Producto{
		...
		{ID: 1, Nombre: "Serum Revitalizante", Precio: 45.00, Img: "https://picsum.photos/seed/serum/800/400"},
		// Agregamos el segundo producto a la lista.
		{ID: 2, Nombre: "Crema Hidratante Pro", Precio: 32.50, Img: "https://picsum.photos/seed/crema/800/400"},
		// Agregamos el tercer producto a la lista.
		{ID: 3, Nombre: "Tónico Purificante", Precio: 28.00, Img: "https://picsum.photos/seed/tonico/800/400"},
		// Agregamos el cuarto producto a la lista.
		{ID: 4, Nombre: "Mascarilla Nocturna", Precio: 50.00, Img: "https://picsum.photos/seed/mascarilla/800/400"},
	}
